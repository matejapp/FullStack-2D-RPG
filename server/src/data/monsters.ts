...
export const monsters: Monster[] = [
  {
    ...
    xp: 50,
    spriteKey: "/assets/Entity/GoblinWarrior.PNG",
    backgroundSprite: "/assets/Backgrounds/GoblinWarriorBackground.jpg",
  },
  {
    id: "giant_spider",
    name: "Giant Spider",
    level: 2,
    stats: { health: 100, attack: 12, defense: 7, magic: 4 },
    moves: giantSpiderMoves,
    xp: 75,
    spriteKey: "/assets/Entity/Spider.PNG",
    backgroundSprite: "/assets/Backgrounds/GiantSpiderBackground.jpg",
  },
  {
    id: "goblin_mage",
    name: "Goblin Mage",
    level: 3,
    stats: { health: 115, attack: 8, defense: 6, magic: 17 },
    moves: goblinMageMoves,
    xp: 100,
    spriteKey: "/assets/Entity/GoblinMage.PNG",
    backgroundSprite: "/assets/Backgrounds/GoblinMageBackground.jpg",
  },
  {
    id: "witch",
    name: "Witch",
    level: 4,
    stats: { health: 130, attack: 10, defense: 7, magic: 19 },
    moves: witchMoves,
    xp: 150,
    spriteKey: "/assets/Entity/Witch.PNG",
    backgroundSprite: "/assets/Backgrounds/WitchBackground.jpg",
  },
  {
    id: "dragon",
    name: "Dragon",
    level: 5,
    stats: { health: 180, attack: 16, defense: 12, magic: 16 },
    moves: dragonMoves,
    xp: 200,
    spriteKey: "/assets/Entity/Dragon.PNG",
    backgroundSprite: "/assets/Backgrounds/DragonBackground.jpg",
  },
];
